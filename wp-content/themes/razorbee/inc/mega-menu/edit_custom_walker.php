...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
	    ...
	    if ( ! empty( $item->_invalid ) ) {
	        ...
	        $title = sprintf( wp_kses_post( __('%s (Invalid)', 'thebuilt' )), $item->title );
	    } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
	        $classes[] = 'pending';
	        /* translators: %s: title of menu item in draft status */
	        $title = sprintf( wp_kses_post(__('%s (Pending)', 'thebuilt')), $item->title );
	    }
	            ...
	            <dt class="menu-item-handle">
	                ...
	                <span class="item-controls">
	                    ...
	                    <span class="item-order hide-if-js">
	                        ...
	                        ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up', 'thebuilt'); ?>">&#8593;</abbr></a>
	                        |
	                        <a href="<?php
	                            echo wp_nonce_url(
	                                esc_url(add_query_arg(
	                        ...
	                        ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down', 'thebuilt'); ?>">&#8595;</abbr></a>
	                    </span>
	                    <a class="item-edit" id="edit-<?php echo intval($item_id); ?>" title="<?php esc_attr_e('Edit Menu Item', 'thebuilt'); ?>" href="<?php
	                    ...
	                    ?>"><?php esc_html_e( 'Edit Menu Item', 'thebuilt' ); ?></a>
	                </span>
	            </dt>
	        </dl>
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo intval($item_id); ?>">
	            <?php if( 'custom' == $item->type ) : ?>
	                <p class="field-url description description-wide">
	                    <label for="edit-menu-item-url-<?php echo intval($item_id); ?>">
	                        <?php esc_html_e( 'URL', 'thebuilt' ); ?><br />
	            ...
	            <p class="description description-thin">
	                <label for="edit-menu-item-title-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Navigation Label', 'thebuilt' ); ?><br />
	            ...
	            <p class="description description-thin">
	                <label for="edit-menu-item-attr-title-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Title Attribute', 'thebuilt' ); ?><br />
	            ...
	            <p class="field-link-target description">
	                <label for="edit-menu-item-target-<?php echo intval($item_id); ?>">
	                    ...
	                    <?php esc_html_e( 'Open link in a new window/tab', 'thebuilt' ); ?>
	                </label>
	            </p>
	            <p class="field-css-classes description description-thin">
	                <label for="edit-menu-item-classes-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'CSS Classes (optional)', 'thebuilt' ); ?><br />
	            ...
	            <p class="field-xfn description description-thin">
	                <label for="edit-menu-item-xfn-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Link Relationship (XFN)', 'thebuilt' ); ?><br />
	            ...
	            <p class="field-description description description-wide">
	                <label for="edit-menu-item-description-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Description', 'thebuilt' ); ?><br />
	                    ...
	                    <span class="description"><?php esc_html_e('The description will be displayed in the menu if the current theme supports it.', 'thebuilt'); ?></span>
	                </label>
	            </p>        
	            <?php
	            ...
	            <p class="field-onepage description description-wide">
					<label for="edit-menu-item-onepage-<?php echo intval($item_id); ?>">
						...
						<?php esc_html_e( 'Use this menu item for Onepage navigation', 'thebuilt' ); ?><br />
	            ...
	            <p class="field-columns description description-wide">
	                <label for="edit-menu-item-columns-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Megamenu columns', 'thebuilt' ); ?><br />
				...
				<p class="field-fullwidth description description-wide">
					<label for="edit-menu-item-fullwidth-<?php echo intval($item_id); ?>">
						...
						<?php esc_html_e( 'Show this submenu fullwidth', 'thebuilt' ); ?><br />
	                    <select id="edit-menu-item-fullwidth-<?php echo intval($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-fullwidth[<?php echo intval($item_id); ?>]">
	                    	<option value="off"<?php if(esc_attr( $item->fullwidth ) == 'off') { echo ' selected'; }?>><?php esc_html_e( 'No', 'thebuilt' ); ?></option>
	                    	<option value="on"<?php if(esc_attr( $item->fullwidth ) == 'on') { echo ' selected'; }?>><?php esc_html_e( 'Yes', 'thebuilt' ); ?></option>
	                    </select>
					</label>
				</p>
				<p class="field-sidebar description description-wide">
	        	<label for="edit-menu-item-sidebar-<?php echo intval($item_id); ?>">
                    <?php esc_html_e( 'Show sidebar with widgets inside this submenu', 'thebuilt' ); ?><br />
                    <select class="sidebar-select code edit-menu-item-custom" id="edit-menu-item-sidebar-<?php echo intval($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-sidebar[<?php echo intval($item_id); ?>]">
					    ...
					    <option value=""><?php esc_html_e( 'Do not add sidebar', 'thebuilt' ); ?></option>
				...
				<p class="field-background-url description description-wide">
	                <label for="edit-menu-item-background_url-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Background image URL', 'thebuilt' ); ?><br />
	            ...
	            <p class="field-backgroundrepeat description description-wide">
	                <label for="edit-menu-item-backgroundrepeat-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Background repeat', 'thebuilt' ); ?><br />
	                    <select id="edit-menu-item-backgroundrepeat-<?php echo intval($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-backgroundrepeat[<?php echo intval($item_id); ?>]">
	                    	<option value="no-repeat"<?php if(esc_attr( $item->backgroundrepeat ) == 'no-repeat') { echo ' selected'; }?>><?php esc_html_e( 'No repeat', 'thebuilt' ); ?></option>
	                    	<option value="repeat"<?php if(esc_attr( $item->backgroundrepeat ) == 'repeat') { echo ' selected'; }?>><?php esc_html_e( 'Repeat', 'thebuilt' ); ?></option>
	                    	<option value="repeat-x"<?php if(esc_attr( $item->backgroundrepeat ) == 'repeat-x') { echo ' selected'; }?>><?php esc_html_e( 'Repeat X', 'thebuilt' ); ?></option>
	                    	<option value="repeat-y"<?php if(esc_attr( $item->backgroundrepeat ) == 'repeat-y') { echo ' selected'; }?>><?php esc_html_e( 'Repeat Y', 'thebuilt' ); ?></option>
	                    </select>
	                </label>
	            </p>
	            <p class="field-backgroundpositionx description description-wide">
	                <label for="edit-menu-item-backgroundpositionx-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Background position X', 'thebuilt' ); ?><br />
	                    <select id="edit-menu-item-backgroundpositionx-<?php echo intval($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-backgroundpositionx[<?php echo intval($item_id); ?>]">
	                    	<option value="center"<?php if(esc_attr( $item->backgroundpositionx ) == 'center') { echo ' selected'; }?>><?php esc_html_e( 'Center', 'thebuilt' ); ?></option>
	                    	<option value="left"<?php if(esc_attr( $item->backgroundpositionx ) == 'left') { echo ' selected'; }?>><?php esc_html_e( 'Left', 'thebuilt' ); ?></option>
	                    	<option value="right"<?php if(esc_attr( $item->backgroundpositionx ) == 'right') { echo ' selected'; }?>><?php esc_html_e( 'Right', 'thebuilt' ); ?></option>
	                  	</select>
	                </label>
	            </p>
	            <p class="field-backgroundpositiony description description-wide">
	                <label for="edit-menu-item-backgroundpositiony-<?php echo intval($item_id); ?>">
	                    <?php esc_html_e( 'Background position Y', 'thebuilt' ); ?><br />
	                    <select id="edit-menu-item-backgroundpositiony-<?php echo intval($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-backgroundpositiony[<?php echo intval($item_id); ?>]">
	                    	<option value="center"<?php if(esc_attr( $item->backgroundpositiony ) == 'center') { echo ' selected'; }?>><?php esc_html_e( 'Center', 'thebuilt' ); ?></option>
	                    	<option value="top"<?php if(esc_attr( $item->backgroundpositiony ) == 'top') { echo ' selected'; }?>><?php esc_html_e( 'Top', 'thebuilt' ); ?></option>
	                    	<option value="bottom"<?php if(esc_attr( $item->backgroundpositiony ) == 'bottom') { echo ' selected'; }?>><?php esc_html_e( 'Bottom', 'thebuilt' ); ?></option>
	                  	</select>
	                </label>
	            </p>
	        	<?php endif; ?>
	        	...
	        	<label for="edit-menu-item-icon-<?php echo intval($item_id); ?>">
                    <?php esc_html_e( 'Menu item Icon', 'thebuilt' ); ?><br />
                    <select class="fontawesome-select code edit-menu-item-custom" id="edit-menu-item-icon-<?php echo intval($item_id); ?>" class="widefat code edit-menu-item-custom" name="menu-item-icon[<?php echo intval($item_id); ?>]">
					    ...
					    <option value="<?php echo esc_attr( $item->icon ); ?>" selected><?php esc_html_e( 'Current icon', 'thebuilt' ); ?></option>
					    <?php endif; ?>
	            ...
	            <div class="menu-item-actions description-wide submitbox">
	                <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
	                    <p class="link-to-original">
	                        <?php printf( esc_html__('Original: %s', 'thebuilt'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
	                    </p>
	                <?php endif; ?>
	                ...
	                ); ?>"><?php esc_html_e('Remove', 'thebuilt'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo intval($item_id); ?>" href="<?php echo esc_url( add_query_arg( array('edit-menu-item' => $item_id, 'cancel' => time()), esc_url(remove_query_arg( $removed_args, admin_url( 'nav-menus.php' ) )) ) );
	                    ?>#menu-item-settings-<?php echo intval($item_id); ?>"><?php esc_html_e('Cancel', 'thebuilt'); ?></a>
	            </div>
